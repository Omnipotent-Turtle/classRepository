...
class Deck  { constructor (){
    ...
    deckCompiler (){ //method that compiles defined cards
    ...
    shuffler(){ //method that swaps the current index of cards with a random one (i.e., shuffle)
...
var playerHandOne = []; //Player Hands set as variables as variables because they are simply containers
var playerHandTwo = [];
